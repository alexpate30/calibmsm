...
The [Overview](https://alexpate30.github.io/calibmsm/articles/BLR-IPCW-manual-bootstrap.html) vignette gives a detailed guide on how to use the package by running through a clinical example.
