...
vignette: >
  %\VignetteIndexEntry{Manual-bootstrap-with-custom-function-for-estimating-the-weights}
...
We now remind ourselves of the procedure for generating a confidence interval, and estimate a confidence interval for a BLR-IPCW calibration curve using the internal bootstrapping procedure, as in done in the vignette \emph{overview.pdf}.
