...
test_that("check calibmsm output, (j = 1, s = 0), curve.type = loess, CI.type = bootstrap", {
  ...
  dat.calib.pv.1 <- calibmsm(data.mstate = msebmtcal,
                             data.raw = ebmtcal,
                             j = 1,
                             s = 0,
                             t = 1826,
  ...
  expect_equal(class(dat.calib.pv.1), c("calib_pv", "calibmsm"))
  ...
  dat.calib.pv.4 <- suppressWarnings(calibmsm(data.mstate = msebmtcal,
                                              data.raw = ebmtcal,
                                              j = 1,
                                              s = 0,
                                              t = 1826,
  ...
  expect_equal(class(dat.calib.pv.4), c("calib_pv", "calibmsm"))
  ...
  dat.calib.pv.9 <- suppressWarnings(calibmsm(data.mstate = msebmtcal,
                                              data.raw = ebmtcal,
                                              j = 1,
                                              s = 0,
                                              t = 1826,
  ...
  expect_equal(class(dat.calib.pv.9), c("calib_pv", "calibmsm"))
  ...
  dat.calib.pv.10 <- suppressWarnings(calibmsm(data.mstate = msebmtcal,
                                               data.raw = ebmtcal,
                                               j = 1,
                                               s = 0,
                                               t = 1826,
  ...
  expect_equal(class(dat.calib.pv.10), c("calib_pv", "calibmsm"))
...
### Run tests for when curve.type = "loess" and CI.type = "bootstrap".
test_that("check calibmsm output, (j = 1, s = 0), curve.type = loess, CI.type = parametric", {
  ...
  dat.calib.pv.5 <- calibmsm(data.mstate = msebmtcal,
                             data.raw = ebmtcal,
                             j = 1,
                             s = 0,
                             t = 1826,
  ...
  ## With confidence interval
  dat.calib.pv.10 <- calibmsm(data.mstate = msebmtcal,
                              data.raw = ebmtcal,
                              j = 1,
                              s = 0,
                              t = 1826,
...
test_that("check calibmsm output, (j = 1, s = 0), curve.type = rcs, CI.type = bootstrap.", {
...
test_that("check calibmsm output, (j = 1, s = 0), curve.type = rcs, CI.type = bootstrap.", {
  ...
  ## Calculate observed event probabilities with a confidence interval using parametric approach
  dat.calib.pv.4 <- calibmsm(data.mstate = msebmtcal,
                             data.raw = ebmtcal,
                             j = 1,
                             s = 0,
                             t = 1826,
...
test_that("check calibmsm output, (j = 1, s = 0), groups.vars and n.pctls = NULL", {
  ...
  ## Calculate observed event probabilities using transitions.out = NULL
  dat.calib.pv.2 <- calibmsm(data.mstate = msebmtcal,
                             data.raw = ebmtcal,
                             j = 1,
                             s = 0,
                             t = 1826,
  ...
  ## Calculate observed event probabilities using transitions.out = NULL
  dat.calib.pv.3 <- calibmsm(data.mstate = msebmtcal,
                             data.raw = ebmtcal,
                             j = 1,
                             s = 0,
                             t = 1826,
...
test_that("check calibmsm output, (j = 1, s = 0), cause errors", {
