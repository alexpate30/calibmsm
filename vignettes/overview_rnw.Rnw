...
---
vignette: >
  %\VignetteIndexEntry{overview_rnw}
  %\VignetteEncoding{UTF-8}
---

\section[Introduction]{Introduction} \label{sec:intro}

\textbf{IF/WHEN PUBLISHED, PDF ARTICLE WILL BE LINKED AS A VIGNETTE FOR GITHUB PAGES WEBSITE USING THIS APPROACH. THE IDEA IS TO USE THE SUBMITTED PAPER AS THE VIGNETTE}
