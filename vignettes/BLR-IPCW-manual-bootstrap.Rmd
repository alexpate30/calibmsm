...
We now remind ourselves of the procedure for generating a confidence interval, and estimate a confidence interval for a BLR-IPCW calibration curve using the internal bootstrapping procedure, as in done in the `vignette("[Overview]")` vignette.
