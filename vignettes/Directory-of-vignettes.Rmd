...
The [Overview](https://alexpate30.github.io/calibmsm/articles/Overview.html) vignette is a guide on how to use the package by running through a clinical example. This should be used as the starting point for understanding how to use **calibmsm**.
