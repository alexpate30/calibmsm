...
test1[["plotdata"]][[1]]$obs == test2[["plotdata"]][[1]]$obs
test1[["plotdata"]][[1]]$pred == test2[["plotdata"]][[1]]$pred

test1[["plotdata"]][[4]]$obs == test2[["plotdata"]][[4]]$obs
test1[["plotdata"]][[4]]$pred == test2[["plotdata"]][[4]]$pred

test3 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
test1[["plotdata"]][[1]] == test3[["plotdata"]][[1]]
length(test3[["plotdata"]]) == 1

test4 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
test1[["plotdata"]][[1]]$obs == test4[["plotdata"]][[1]]$obs
test1[["plotdata"]][[1]]$pred == test4[["plotdata"]][[1]]$pred

test1[["plotdata"]][[4]]$obs == test4[["plotdata"]][[4]]$obs
test1[["plotdata"]][[4]]$pred == test4[["plotdata"]][[4]]$pred


test5 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
test4[["plotdata"]][[1]]$obs == test5[["plotdata"]][[1]]$obs
test4[["plotdata"]][[1]]$pred == test5[["plotdata"]][[1]]$pred

test4[["plotdata"]][[4]]$obs == test5[["plotdata"]][[4]]$obs
test4[["plotdata"]][[4]]$pred == test5[["plotdata"]][[4]]$pred

test6 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
test4[["plotdata"]][[1]]$obs == test6[["plotdata"]][[1]]$obs
length(test6[["plotdata"]]) == 1

test7 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
test4[["plotdata"]][[1]]$obs != test7[["plotdata"]][[1]]$obs
length(test7[["plotdata"]]) == 1

test8 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
### Test7 should be a bigger confidence interval
mean(test7[["plotdata"]][[1]]$obs.upper - test7[["plotdata"]][[1]]$obs.lower, na.rm = TRUE) >
  mean(test8[["plotdata"]][[1]]$obs.upper - test8[["plotdata"]][[1]]$obs.lower, na.rm = TRUE)

save.image("workflow/calc_calib_pseudo_tests.RData")


###
### Tests to see if output is in correct format when assign data.pred.plot manually
###
ncol(test1[["plotdata"]][[1]]) == 3
ncol(test4[["plotdata"]][[1]]) == 5
...
test9 <- calc_calib_pv(data.mstate = msebmtcal,
                       data.raw = ebmtcal,
                       j = 3,
                       s = 100,
                       t.eval = 1826,
...
ncol(test9[["plotdata"]][[1]]) == 2
ncol(test9[["plotdata"]][[1]]) == 4

nrow(test1[["plotdata"]][[1]]) == nrow(test9[["plotdata"]][[1]])
nrow(test1[["plotdata"]][[4]]) == nrow(test9[["plotdata"]][[4]])

### But results for obs and pred should be the same, as defined data.predplot to be tp.pred

###
### Only issue I see is that test 1 doesn't have patient ids?
###
